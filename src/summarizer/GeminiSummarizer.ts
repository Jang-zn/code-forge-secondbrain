  ...
  "topics": [
    {
      ...
      "summary": "이 주제에서 무엇을, 왜, 어떤 방식으로 했는지 5-10문장으로 요약 (한글로). 접근 방식의 선택 이유를 포함하세요.",
      ...
      "insights": ["이 작업에서 얻은 재사용 가능한 교훈/인사이트 (한글로). 예: 'chokidar의 awaitWriteFinish 옵션 없이 쓰면 부분 기록된 파일을 읽게 된다', 'TypeScript의 satisfies는 타입 추론을 유지하면서 타입 검증을 할 수 있다'. 교훈이 없으면 빈 배열."],
